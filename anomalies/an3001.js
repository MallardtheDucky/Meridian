const DB_AN3001_SECTIONS = [
        { id: 'entry', label: 'OBJECT DATA', sub: 'AN-3-001 Entry', icon: 'file-text' },
    ...
    function anSectionEntry() {
        ...
        <div class="doc-sheet mb-4" style="max-width:none;">
            <div class="doc-stamp">CLASS 3</div>
            <div class="doc-sheet-header" style="grid-template-columns: repeat(4, 1fr);">
                <div><div class="doc-sheet-field-label">Designation</div><div class="doc-sheet-field-value">AN-3-001</div></div>
        ...
        <div class="tech-border bg-[var(--color-panel)] p-3 mt-3 flex items-center gap-3">
            ...
            <div class="text-[10px] text-[var(--color-text-dim)]">ADDITIONAL PHOTOGRAPHIC DOCUMENTATION: PENDING. Expedition imaging team clearance for interior photography is pending Council review; recovered helmet-camera stills remain restricted to Historical Archives pending redaction pass.</div>
        </div>
    ...
    function anSectionRecording() {
        const log1 = renderAudioLog('an3001-log-1', {
        ...
        const log2 = renderAudioLog('an3001-log-2', {
        ...
        const log3 = renderAudioLog('an3001-log-3', {
        ...
        const log4 = renderNorthstarAudioLog(AN3001_AUDIO_ID, {
    ...
    function anSectionInterview() {
        const interview = renderAudioLog('an3001-log-interview', {
    ...
    function renderAnomalyAN3001() {
        ...
        const navHtml = DB_AN3001_SECTIONS.map(s => `
        ...
        <div class="w-full h-full flex flex-col md:flex-row font-mono-tech bg-black">
            <div class="w-full md:w-64 md:shrink-0 flex flex-col bg-[#04080c] border-b md:border-b-0 md:border-r border-[var(--color-panel-border)]">
                <div class="bg-[var(--color-panel)] p-3 border-b border-[var(--color-cyan)]">
                    <div class="flex items-center gap-2 mb-1">
                        <i data-lucide="ship" class="w-4 h-4 text-[var(--color-cyan)]"></i>
                        <span class="text-xs text-white font-bold tracking-widest">AN-3-001</span>
                    </div>
                    <div class="text-[9px] text-[var(--color-cyan)] tracking-[0.2em]">NORTHSTAR</div>
                    <div class="flex flex-wrap gap-1 mt-2">
                        <span class="an-badge" style="color:var(--color-cyan);">CLASS 3</span>
